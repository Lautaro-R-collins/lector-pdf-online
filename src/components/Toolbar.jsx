...
export default function Toolbar({ sidebarOpen, onToggleSidebar }) {
  const { activeTab, setPageNumber, setScale, darkMode, setDarkMode } = usePDFContext()
  ...
  const { pageNumber = 1, numPages = 0, scale = 1.2, searchResults = [], searchIndex = 0, searchQuery = '' } = activeTab ?? {}
